...
export default function LiquidEther({
  ...
  resolution = 0.5,
  isBounce = false,
  colors = ['#4c1d95', '#7c3aed', '#a78bfa'], // Bookflix primary shades
  style = {},
  className = '',
  autoDemo = true,
  autoSpeed = 0.5,
  ...
  useEffect(() => {
    ...
    // Darker semi-transparent background for the canvas itself
    const bgVec4 = new THREE.Vector4(0.05, 0.02, 0.1, 0.4); 
    ...
    class CommonClass {
      ...
      init(container) {
        ...
        // Dark clear color
        this.renderer.setClearColor(new THREE.Color(0x0a0514), 1.0); 
